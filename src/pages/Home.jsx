...
function Home()
{
    ...
    return(
        <div className="">
            ...
            <img src={imag1} alt="salad" className="dark:block hidden h-auto w-full  fixed -z-10"/>
            ...
            <div className="select-none my-8 absolute p-6 w-full ">
                ...
                <div className="flex flex-col items-center w-full gap-16">
                    ...
                    <form onSubmit={item} className="flex flex-row items-center gap-6">
                        <input id="in" autoComplete='off' placeholder="Enter the dish..."  type="text" className="dark:bg-orange-800 opacity-80 justify-center font-semibold font-sora rounded-3xl w-96 dark:placeholder-rose-100 dark:text-white outline-none p-1 text-2xl  text-lime-800 bg-yellow-50  text-center py-2"/>
                    </form>
                </div>
